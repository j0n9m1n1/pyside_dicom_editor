...
class MainWindow(QMainWindow):
    ...
    def ui_init(self):
        ...
        self.button_confirm_path = QPushButton()
    ...
    def ui_setup(self):
        self.tab_widget.addTab(self.tab, 'Tab')
        ...
        self.button_confirm_path.setText("Get")
        ...
        self.grid_layout2.addWidget(self.list_widget_tag, 0, 0)
        self.grid_layout2.addWidget(self.line_edit_tag, 0, 1)
